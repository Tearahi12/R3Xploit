    ...
    internal class Injector
    {
        ...
        public sealed class DllInjector
        {
            ...
            public Injector.DllInjectionResult Inject(string sProcName, string sDllPath)
            {
                ...
                return pToBeInjected == 0U ? Injector.DllInjectionResult.GameProcessNotFound : (!this.bInject(pToBeInjected, sDllPath) ? Injector.DllInjectionResult.InjectionFailed : Injector.DllInjectionResult.Success);
            }
